...
json_file_path = "/mnt/workspace/qinshiyang/AniPortrait_custom/utils/pick_vid_test/ours_without3dproj_oldv1/model_out_ours_v1.json"
...
for key in data.keys():
    index +=1
    source_video_path = data[key]["gt_video_save_path"]
    modelout_save_path = data[key]["modelout_save_path"]
    result = calculate_video_metrics(source_video_path, modelout_save_path , max_frames=16)
...
out_json= '/mnt/workspace/qinshiyang/AniPortrait_custom/utils/pick_vid_test/ours_without3dproj_oldv1/video_metrics_ours_v1_result_without3dproj_0704.json'
